...
! function(a, b) {
	...
	d.prototype = {
		_init: function() {
			var a = this;
			this.settings = b.extend({}, this.defaults, this.options), this.$maskContainer = b('<div class="as-mask"></div>').appendTo(this.$accordion), this.$panelsContainer = this.$accordion.find(".as-panels").appendTo(this.$maskContainer), 0 === this.$panelsContainer.length && (this.$panelsContainer = b('<div class="as-panels"></div>').appendTo(this.$maskContainer));
			var d = b.AccordionSlider.modules.accordion;
			if ("undefined" != typeof d)
				for (var e in d) "undefined" != typeof this["init" + d[e]] && this["init" + d[e]]();
			if (this.originalSettings = b.extend({}, this.settings), this.currentIndex = this.settings.startPanel, -1 !== this.currentIndex && this.$accordion.addClass("as-opened"), -1 !== this.settings.startPage && (this.currentPage = this.settings.startPage), null !== this.settings.breakpoints) {
				for (var f in this.settings.breakpoints) this.breakpoints.push({
					size: parseInt(f, 10),
					properties: this.settings.breakpoints[f]
				});
			...
			if (this._prepareRAF(), this.update(), -1 !== this.currentIndex) {
				...
				this.trigger(g), b.isFunction(this.settings.panelOpen) && this.settings.panelOpen.call(this, g)
			}
			this.on("mouseenter." + c, function() {
				var c = {
					type: "accordionMouseOver"
				};
				a.trigger(c), b.isFunction(a.settings.accordionMouseOver) && a.settings.accordionMouseOver.call(a, c)
			}), this.on("mouseleave." + c, function() {
				a.settings.closePanelsOnMouseOut === !0 && a.closePanels();
				var c = {
					type: "accordionMouseOut"
				};
				a.trigger(c), b.isFunction(a.settings.accordionMouseOut) && a.settings.accordionMouseOut.call(a, c)
			}), this.trigger({
				type: "init"
		...
		update: function() {
			...
			if ("horizontal" === this.settings.orientation ? (this.$accordion.removeClass("as-vertical").addClass("as-horizontal"), this.positionProperty = "left", this.sizeProperty = "width") : "vertical" === this.settings.orientation && (this.$accordion.removeClass("as-horizontal").addClass("as-vertical"), this.positionProperty = "top", this.sizeProperty = "height"), this.$panelsContainer.attr("style", ""), this.settings.responsive === !0 ? (this.$accordion.css({
				...
				maxWidth: "",
				maxHeight: ""
			}), this.$maskContainer.attr("style", "")), -1 === this.settings.visiblePanels) this.currentPage = 0;
			...
			this.settings.panelDistance > 0 || this.settings.panelOverlap === !1 ? (this.isOverlapping = !1, this.$accordion.removeClass("overlap")) : this.settings.panelOverlap === !0 && (this.isOverlapping = !0, this.$accordion.addClass("overlap")), this.$accordion.find("img.as-background, img.as-background-opened").css({
				width: "",
				height: ""
			}), this._updatePanels(), this._updatePaginationButtons(), this.resize(), this.settings.shadow === !0 ? this.$accordion.find(".as-panel").addClass("as-shadow") : this.settings.shadow === !1 && this.$accordion.find(".as-shadow").removeClass("as-shadow");
			var f = {
				type: "update"
			};
			d.trigger(f), b.isFunction(d.settings.update) && d.settings.update.call(d, f)
		},
		...
		_createPanel: function(a, d) {
			...
			this.panels.splice(a, 0, h), h.on("panelMouseOver." + c, function(c) {
				...
				"click" === f.settings.openPanelOn && (a !== this.currentIndex ? f.openPanel(c.index) : f.closePanels());
				var d = {
					type: "panelClick",
					index: a
				};
		...
		closePanels: function() {
			...
			this.currentIndex = -1, this.$accordion.hasClass("as-closed") === !1 && (this.$accordion.removeClass("as-opened"), this.$accordion.addClass("as-closed")), clearTimeout(this.mouseDelayTimer);
		...
		_updatePaginationButtons: function() {
			...
			if (1 >= e && 0 !== a.length) a.remove(), a.off("click." + c, ".as-pagination-button"), this.off("pageScroll." + c);
	...
	e.prototype = {
		...
		destroy: function() {
			...
			if ("undefined" != typeof a)
				for (var c in a) "undefined" != typeof this["destroy" + a[c]] && this["destroy" + a[c]]()
		},
		getIndex: function() {
			return this.index
		},
		...
		getContentSize: function() {
			...
			if (this.settings.panelOverlap === !1 || parseInt(this.settings.panelDistance, 10) > 0) {
				var b = this.$panel.css(this.sizeProperty);
				this.$panel.css(this.sizeProperty, 10), a = "width" === this.sizeProperty ? this.$panel[0].scrollWidth : this.$panel[0].scrollHeight, this.$panel.css(this.sizeProperty, b)
			} else "width" === this.sizeProperty ? (this.$panel.css({
				width: "100px",
				overflow: "hidden"
			}), a = this.$panel[0].scrollWidth, this.$panel.css({
				width: "",
				overflow: ""
			})) : (this.$panel.css({
				height: "100px",
				overflow: "hidden"
			}), a = this.$panel[0].scrollHeight, this.$panel.css({
				height: "",
				overflow: ""
			}));
			return a
	...
	var c = b.AccordionSlider.namespace,
		d = {
			...
			initAutoplay: function() {
				var a = this;
				b.extend(this.settings, this.autoplayDefaults, this.options), this.settings.autoplay === !0 && this.startAutoplay(), this.on("panelOpen.Autoplay." + c, function(b) {
...
function(a, b) {
	...
	var c = b.AccordionSlider.namespace,
		d = {
			...
			initJSON: function() {
				b.extend(this.settings, this.JSONDefaults, this.options), null !== this.settings.JSONSource && this.updateJSON()
			},
			updateJSON: function() {
				var a = this;
	...
	var c = b.AccordionSlider.namespace,
		d = {
			initKeyboard: function() {
				var a = this,
					d = !1;
				b.extend(this.settings, this.keyboardDefaults, this.options), this.settings.keyboard !== !1 && (this.$accordion.on("focus.Keyboard." + c, function() {
					d = !0
...
function(a, b) {
	...
	i.prototype = {
		...
		_setPosition: function() {
			"undefined" != typeof this.data.horizontal ? "center" === this.data.horizontal ? (-1 === this.$layer.attr("style").indexOf("width") && (this.$layer.css("white-space", "nowrap"), this.$layer.css("width", this.$layer.outerWidth(!0))), this.$layer.css({
				marginLeft: "auto",
				marginRight: "auto",
				left: 0,
				right: 0
			})) : this.$layer.css(this.horizontalPosition, this.data.horizontal) : this.$layer.css(this.horizontalPosition, 0), "undefined" != typeof this.data.vertical ? "center" === this.data.vertical ? (-1 === this.$layer.attr("style").indexOf("height") && (this.$layer.css("white-space", "nowrap"), this.$layer.css("height", this.$layer.outerHeight(!0))), this.$layer.css({
				marginTop: "auto",
				marginBottom: "auto",
				top: 0,
				bottom: 0
			...
			if (this.isVisible !== !0) {
				...
				if ("always" === this.visibleOn || "msie" === f && parseInt(g, 10) <= 7) this.$layer.css("visibility", "visible");
					...
					var h = {
						...
						i = "";
					"left" === this.data.showTransition ? i = c + "px, 0" : "right" === this.data.showTransition ? i = "-" + c + "px, 0" : "up" === this.data.showTransition ? i = "0, " + c + "px" : "down" === this.data.showTransition && (i = "0, -" + c + "px"), h.transform = "3d" === j.useTransforms() ? "translate3d(" + i + ", 0)" : "translate(" + i + ")";
					var k = {
						opacity: 1,
						transition: "all " + d + "s"
					};
					"undefined" != typeof this.data.showTransition && (k.transform = "3d" === j.useTransforms() ? "translate3d(0, 0, 0)" : "translate(0, 0)"), this.$layer.on("transitionend webkitTransitionEnd oTransitionEnd msTransitionEnd", function() {
			...
			if (this.isVisible !== !1) {
				...
				if ("always" === this.visibleOn || "msie" === f && parseInt(g, 10) <= 7) this.$layer.css("visibility", "hidden");
					...
					var h = {
						...
						i = "";
					"left" === this.data.hideTransition ? i = "-" + c + "px, 0" : "right" === this.data.hideTransition ? i = c + "px, 0" : "up" === this.data.hideTransition ? i = "0, -" + c + "px" : "down" === this.data.hideTransition && (i = "0, " + c + "px"), h.transform = "3d" === j.useTransforms() ? "translate3d(" + i + ", 0)" : "translate(" + i + ")", this.$layer.on("transitionend webkitTransitionEnd oTransitionEnd msTransitionEnd", function() {
			...
			_loadImage: function(a) {
				if ("undefined" != typeof a.attr("data-src")) {
					...
					c.attr("class", a.attr("class")), c.attr("style", a.attr("style")), b.each(a.data(), function(a, b) {
						c.attr("data-" + a, b)
					}), "undefined" != typeof a.attr("width") && c.attr("width", a.attr("width")), "undefined" != typeof a.attr("height") && c.attr("height", a.attr("height")), c.insertAfter(a), a.remove(), c.attr("src", a.attr("data-src")), c.removeAttr("data-src")
				}
			},
	...
	var c = b.AccordionSlider.namespace,
		d = {
			...
			initMouseWheel: function() {
				var a = this;
				b.extend(this.settings, this.mouseWheelDefaults, this.options), this.settings.mouseWheel !== !1 && ("onwheel" in document ? this.mouseWheelEventType = "wheel" : "onmousewheel" in document ? this.mouseWheelEventType = "mousewheel" : "onDomMouseScroll" in document ? this.mouseWheelEventType = "DomMouseScroll" : "onMozMousePixelScroll" in document && (this.mouseWheelEventType = "MozMousePixelScroll"), this.on(this.mouseWheelEventType + "." + c, function(b) {
					b.preventDefault();
...
function(a, b) {
	...
	var c = b.AccordionSlider.namespace,
		d = {
			...
			_isRetina: function() {
				return a.devicePixelRatio >= 2 ? !0 : a.matchMedia && a.matchMedia("(-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dpi)").matches ? !0 : !1
			},
			...
			_loadRetinaImage: function(a) {
				...
				if ("undefined" != typeof a.attr("data-retina") && (c = !0, d = a.attr("data-retina"), a.removeAttr("data-retina")), "undefined" != typeof a.attr("data-src") && (c === !1 && (d = a.attr("data-src")), a.removeAttr("data-src")), "" !== d) {
					...
					e.attr("class", a.attr("class")), e.attr("style", a.attr("style")), b.each(a.data(), function(a, b) {
						e.attr("data-" + a, b)
					}), "undefined" != typeof a.attr("width") && e.attr("width", a.attr("width")), "undefined" != typeof a.attr("height") && e.attr("height", a.attr("height")), e.insertAfter(a), a.remove(), e.attr("src", d)
				}
			},
...
function(a, b) {
	...
	var d = {
		initSmartVideo: function() {
			b.extend(this.settings, this.smartVideoDefaults, this.options), this._setupVideos()
		},
...
function(a) {
	...
	var b = window.navigator.userAgent.toLowerCase(),
		c = null !== b.match(/ipad/i) || null !== b.match(/ipod/i) || null !== b.match(/iphone/i),
		d = function(b, c) {
	...
	d.prototype = {
		...
		play: function() {
			c === !0 && this.player.isStarted() === !1 || "playing" === this.player.getState() || this.player.play()
		},
		stop: function() {
			c === !0 && this.player.isStarted() === !1 || "stopped" === this.player.getState() || this.player.stop()
		},
		pause: function() {
			c === !0 && this.player.isStarted() === !1 || "paused" === this.player.getState() || this.player.pause()
		},
		replay: function() {
			(c !== !0 || this.player.isStarted() !== !1) && this.player.replay()
		},
		on: function(a, b) {
		...
		destroy: function() {
			this.player.isStarted() === !0 && this.stop(), this.player.off("ready"), this.player.off("start"), this.player.off("play"), this.player.off("pause"), this.player.off("ended")
		},
		defaults: {
			videoReady: function() {},
			videoStart: function() {},
		...
		return this.each(function() {
			if ("undefined" == typeof a(this).data("videoController")) {
				...
				"function" == typeof f[b] ? f[b].apply(f, c) : a.error(b + " does not exist in videoController.")
			}
		})
	};
	var e = function(b) {
	...
	var f = {
		...
		g = function(b) {
			...
			if ("undefined" != typeof c) e.call(this, b);
			else if (f.youtubeVideos.push({
				video: b,
				scope: this
			}), f.youtubeAPIAdded === !1) {
				f.youtubeAPIAdded = !0;
				...
				g.parentNode.insertBefore(d, g), window.onYouTubePlayerAPIReady = function() {
					a.each(f.youtubeVideos, function(a, b) {
						e.call(b.scope, b.video)
					})
				}
			}
		};
	g.prototype = new e, g.prototype.constructor = g, a.VideoController.addPlayer("YoutubeVideo", g), g.isType = function(a) {
		if (a.is("iframe")) {
			var b = a.attr("src");
		...
		c === !0 ? this.stop() : this.player.pauseVideo()
		...
		var c = this;
		if (this.init === !0) e.prototype.on.call(this, a, b);
		else var d = setInterval(function() {
			c.init === !0 && (clearInterval(d), e.prototype.on.call(c, a, b))
		}, 100)
	};
	var h = {
			vimeoAPIAdded: !1,
		...
		i = function(b) {
			if (this.init = !1, "undefined" != typeof window.Froogaloop) e.call(this, b);
			else if (h.vimeoVideos.push({
				video: b,
				scope: this
			}), h.vimeoAPIAdded === !1) {
				h.vimeoAPIAdded = !0;
				...
				var f = setInterval(function() {
					"undefined" != typeof window.Froogaloop && (clearInterval(f), a.each(h.vimeoVideos, function(a, b) {
						e.call(b.scope, b.video)
					}))
				}, 100)
			}
		};
	i.prototype = new e, i.prototype.constructor = i, a.VideoController.addPlayer("VimeoVideo", i), i.isType = function(a) {
		if (a.is("iframe")) {
			var b = a.attr("src");
	...
	j.prototype = new e, j.prototype.constructor = j, a.VideoController.addPlayer("HTML5Video", j), j.isType = function(a) {
	...
	k.prototype = new e, k.prototype.constructor = k, a.VideoController.addPlayer("VideoJSVideo", k), k.isType = function(a) {
	...
	l.prototype = new e, l.prototype.constructor = l, a.VideoController.addPlayer("SublimeVideo", l), l.isType = function(a) {
	...
	m.prototype = new e, m.prototype.constructor = m, a.VideoController.addPlayer("JWPlayerVideo", m), m.isType = function(a) {
	...
	var c = b.AccordionSlider.namespace,
		...
		e = {
			initSwapBackground: function() {
				var a = this;
				b.extend(this.settings, this.swapBackgroundDefaults, this.options), this.on("panelOpen.SwapBackground." + c, function(b) {
					...
					if (0 !== e.length && (e.css({
						visibility: "visible",
						opacity: 0
					}), a._fadeInBackground(e), 0 !== d.length && a.settings.fadeOutBackground === !0 && a._fadeOutBackground(d)), -1 !== b.previousIndex) {
			...
			_fadeInBackground: function(a) {
				...
				d.checkCSSTransitions() === !0 ? (a.off(d.cssTransitionEndEvents).on(d.cssTransitionEndEvents, function() {
					a.off(d.cssTransitionEndEvents), a.css({
						transition: ""
					})
				}), setTimeout(function() {
					a.css({
	...
	var c = b.AccordionSlider.namespace,
		d = {
			...
			initTouchSwipe: function() {
				var d = this;
				if (b.extend(this.settings, this.touchSwipeDefaults, this.options), this.settings.touchSwipe !== !1) {
					this.isTouchSupport = "ontouchstart" in a;
					var e = this.isTouchSupport ? "touchstart" : "mousedown";
					this.$panelsContainer.on(e + "." + c, b.proxy(this._onTouchStart, this)), this.on("update.TouchSwipe." + c, function() {
						d.isTouchSupport && b.each(d.panels, function(a, b) {
							var d = b;
							d.off("panelMouseOver." + c), d.off("panelMouseOut." + c), d.off("panelClick." + c)
						}), d.getTotalPages() > 1 ? d.$panelsContainer.addClass("as-grab") : d.$panelsContainer.removeClass("as-grab")
					})
				}
			},
			_onTouchStart: function(a) {
				if (!(b(a.target).closest(".selectable").length >= 1 || this.isTouchSupport === !1 && 1 === this.getTotalPages())) {
					this.isTouchSupport === !1 && a.preventDefault();
					var d = this.isTouchSupport ? a.originalEvent.touches[0] : a.originalEvent,
						e = this.isTouchSupport ? "touchmove" : "mousemove",
						f = this.isTouchSupport ? "touchend" : "mouseup";
			...
			_onTouchMove: function(a) {
				...
				this.isTouchMoving = !0, this.touchEndPoint.x = b.pageX, this.touchEndPoint.y = b.pageY, this.touchDistance.x = this.touchEndPoint.x - this.touchStartPoint.x, this.touchDistance.y = this.touchEndPoint.y - this.touchStartPoint.y;
			...
			_onTouchEnd: function(a) {
				var d = this.isTouchSupport ? "touchmove" : "mousemove",
					e = this.isTouchSupport ? "touchend" : "mouseup";
				if (this.$panelsContainer.off(d + "." + c), b(document).off(e + "." + this.uniqueId + "." + c), this.$panelsContainer.removeClass("as-grabbing").addClass("as-grab"), this.isTouchSupport === !0 && (this.isTouchMoving === !1 || this.isTouchMoving === !0 && Math.abs(this.touchDistance.x) < 10 && Math.abs(this.touchDistance.y) < 10)) {
					var f = b(a.target).parents(".as-panel").index();
					return f !== this.currentIndex && -1 !== f ? this.openPanel(f) : b(a.target).parents(".as-panel").find("a").removeClass("as-swiping").off("click.TouchSwipe"), void 0
				}
				if (this.isTouchMoving === !1) return b(a.target).parents(".as-panel").find("a").removeClass("as-swiping").off("click.TouchSwipe"), void 0;
				this.isTouchMoving = !1, setTimeout(function() {
					b(a.target).parents(".as-panel").find("a").removeClass("as-swiping")
				}, 1);
				var g = {};
				g[this.positionProperty] = this.touchStartPosition, "horizontal" === this.settings.orientation ? this.touchDistance.x > this.settings.touchSwipeThreshold ? this.currentPage > 0 ? this.previousPage() : this.$panelsContainer.stop().animate(g, 300) : -this.touchDistance.x > this.settings.touchSwipeThreshold ? this.currentPage < this.getTotalPages() - 1 ? this.nextPage() : this.gotoPage(this.currentPage) : Math.abs(this.touchDistance.x) < this.settings.touchSwipeThreshold && this.$panelsContainer.stop().animate(g, 300) : "vertical" === this.settings.orientation && (this.touchDistance.y > this.settings.touchSwipeThreshold ? this.currentPage > 0 ? this.previousPage() : this.$panelsContainer.stop().animate(g, 300) : -this.touchDistance.y > this.settings.touchSwipeThreshold ? this.currentPage < this.getTotalPages() - 1 ? this.nextPage() : this.$panelsContainer.animate(g, 300) : Math.abs(this.touchDistance.y) < this.settings.touchSwipeThreshold && this.$panelsContainer.stop().animate(g, 300))
			},
			destroyTouchSwipe: function() {
				var a = this.isTouchSupport ? "touchstart" : "mousedown",
					d = this.isTouchSupport ? "touchend" : "mouseup",
					e = this.isTouchSupport ? "touchmove" : "mousemove";
				this.$panelsContainer.off(a + "." + c), b(document).off(d + "." + this.uniqueId + "." + c), this.$panelsContainer.off(e + "." + c), this.off("update.TouchSwipe." + c)
			},
			touchSwipeDefaults: {
				touchSwipe: !0,
...
function(a, b) {
	...
	var c = b.AccordionSlider.namespace,
		...
		h = {
			...
			initXML: function() {
				b.extend(this.settings, this.XMLDefaults, this.options), null !== this.settings.XMLSource && this.updateXML()
			},
			updateXML: function() {
				var a = this;
